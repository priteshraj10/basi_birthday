    ...
    places.forEach(place => {
      ...
      marker.addEventListener('click', () => {
        ...
        if (window.google && window.google.maps) {
          ...
          if (map) {
            // Open info window directly with the marker element
            // Get the underlying DOM element from the marker
            const markerElement = marker.querySelector('.google-maps-marker');
