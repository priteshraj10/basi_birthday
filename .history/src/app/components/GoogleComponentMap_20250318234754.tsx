...
const GoogleComponentMap: React.FC<GoogleComponentMapProps> = ({ places }) => {
  ...
  // Memoize the createMapAndMarkers function with useCallback
  ...
  }, [places, selectedPlace, showDirections, userLocation, placesApiAvailable]);
  ...
  useEffect(() => {
    ...
    initComponents();
  }, [scriptLoaded, createMapAndMarkers]);
