...
// Type for the routing control
interface RoutingControlType {
  addTo: (map: L.Map) => L.Routing.Control;
  removeFrom: (map: L.Map) => L.Routing.Control;
}
  ...
  useEffect(() => {
    ...
    const importRoutingMachine = async () => {
      if (typeof window !== 'undefined') {
        try {
          // We need to dynamically import the routing machine
